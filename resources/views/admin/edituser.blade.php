            ...
            <div id="content">
                ...
                <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id" id="id" class="form-control" required value="{{ old('id', $user->id) }}">
                            @if($errors->has('id'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-control" required value="{{ old('nama', $user->nama) }}">
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_guru" id="kode_guru" class="form-control" value="{{ old('kode_guru', $user->kode_guru) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="poin" id="poin" class="form-control" required min="0" value="{{ old('poin', $user->poin) }}">
                            @if($errors->has('poin'))

...
<head>
    ...
    <title>Sanggah Laporan | SI APEM</title>
                                ...
                                <ul class="list-unstyled mb-6">
                                  ...
                                  <li class="mb-2">
                                    ...
                                    <span><br>
                                        ...
                                        <img class="img-fluid w-50 " src="{{ route('guru.image.show', ['id' => $encryptedId]) }}" alt="Encrypted Image">
                    ...
                    <div class="col-12 col-lg-7 mt-2 mb-2">
                        <div class="card mb-6">
                            <div class="card-body pt-12">
                              ...
                              <form action="{{route('guru.laporan.sanggah.upload',  ['id' => $encryptedId])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="info-container">
                                    <ul class="list-unstyled mb-6">
                                      <li class="mb-2">
